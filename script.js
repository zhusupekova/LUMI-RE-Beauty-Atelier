const services = [
  {
    group: "Волосы",
    items: [
      ["Женская стрижка", "по запросу", "60 мин", "Форма, которая держится после салона и подходит вашему образу жизни."],
      ["Окрашивание", "по запросу", "2-4 часа", "Тон, глубина и бережная техника после консультации колориста."],
      ["Укладка", "по запросу", "45 мин", "Легкая дневная или выразительная вечерняя укладка без перегруза."],
      ["Уход для волос", "по запросу", "75 мин", "Восстановление блеска, мягкости и плотности профессиональными составами."],
    ],
  },
  {
    group: "Ногти",
    items: [
      ["Маникюр с покрытием", "по запросу", "90 мин", "Чистая форма, ровное покрытие и стерильный инструмент для каждой гостьи."],
      ["Педикюр", "по запросу", "90 мин", "Аккуратный уход, комфортная обработка и стойкий финиш."],
    ],
  },
  {
    group: "Брови и ресницы",
    items: [
      ["Коррекция и окрашивание бровей", "по запросу", "45 мин", "Мягкая архитектура бровей с оттенком под волосы и кожу."],
      ["Ламинирование ресниц", "по запросу", "60 мин", "Естественный изгиб и выразительность без ежедневной туши."],
    ],
  },
  { group: "Макияж", items: [["Макияж вечерний", "по запросу", "75 мин", "Стойкий образ для события, съемки или важного вечера."]] },
  { group: "Косметология", items: [["Spa-ритуал для лица", "по запросу", "60 мин", "Деликатное очищение, массаж и уход под актуальное состояние кожи."]] },
  { group: "Spa", items: [["Расслабляющий spa-уход", "по запросу", "70 мин", "Тихий ритуал восстановления с ароматерапией и мягкими техниками."]] },
];
